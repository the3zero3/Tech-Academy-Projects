...
const Calculator = {
    ...
    //This will hold the operator; we'll set it to null for now
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    //When an operand key is pressed, we convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand if it doesn't already exist
